...
namespace storage_lab
{
    class Program
    {
        ...
        private static string blobName="1.png";
        private static string connectionString= "DefaultEndpointsProtocol=https;AccountName=jarretttest;AccountKey=81qUVgAkg0rQA0VKlAnap066i1gc5qXtejMG3ZLiwqRhAQFBJnsWnlOszBK2+GEIrEoZwcqwf0Tz+AStbwai8A==;EndpointSuffix=core.windows.net";
        ...
        private async static void ListBlobMetadata()
        {
            try
            {
                ...
                {
                    Console.WriteLine($" IndexTags: {{{tag.Key}={tag.Value}}}");
                }
            }
            catch (RequestFailedException e)
            {
